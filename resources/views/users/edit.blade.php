            ...
            <div class="card-body p-4">
              ...
              <form method="POST" action="{{ route('users.update', $info->id) }}">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" name="firstName" class="form-control" id="firstName" value="{{ $info->first_name }}">
                </div>
                <div class="mb-3">
                  <label for="lastName" class="form-label fw-semibold">Last Name</label>
                  <input type="text" name="lastName" class="form-control" id="lastName" value="{{ $info->last_name }}">
                </div>
                <div class="mb-3">
