      ...
      <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
        ...
        <div class="hidden sm:ml-6 sm:block">
          <div class="flex space-x-4">
            ...
            @endphp
            <a href="{{ route('index') }}" class=" {{ request()->routeIs('index') ? $current : $default }} rounded-md hover:bg-gray-700 px-3 py-2 text-sm font-medium" aria-current="page">Home</a>
            <a href="{{ route('admin') }}" class="  {{ request()->routeIs('admin') ? $current : $default }} rounded-md px-3 py-2 text-sm font-medium ">Admin</a>
          </div>
        </div>
      </div>
